...
import Image3 from "../../images/slider/avalon-park/avalon-park-3.png";
import Image4 from "../../images/slider/avalon-park/avalon-park-4.png";
import Logo from "../../images/logo-1.png"
import AssetzMarqModal from "./AssetzMarqModal";

const AssetzMarqSlider = () => {
            ...
            <Row className="">
              <Col md={8} className="">
                <div className="m-1 text-center text-md-start">
                  <h1 className="text-primary fs-2">Assetz Marq 3.0</h1>
                  <p className="m-0">
                    <p className="text-center text-md-start mb-0">3 & 4 BHK Ultra Modern Apartments @ Whitefield, Bangalore</p>
                    <p className="text-center text-md-start mb-0">1.10* Cr Onwards</p>
                  </p>
                </div>
              </Col>
...
export default AssetzMarqSlider
