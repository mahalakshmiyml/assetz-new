            ...
            <Row className="">
              <Col md={8} className="">
                <div className="m-1 text-center text-md-start">
                  <h1 className="fs-4 text-primary">Assetz - The Downtown Neighbourhood</h1>
                  <p className="m-0">
                    {" "}
                    <p className="text-center text-md-start mb-0">Thanisandra, Bangalore</p>
                    <p className="text-center text-md-start mb-0">1.91* Cr Onwards</p>
                  </p>
                </div>
              </Col>
